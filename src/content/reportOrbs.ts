...
export const REPORT_ORBS: OrbData[] = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      `Not merely odd, coronal rain serves as a key tool for exploring this puzzle (Antolin 2020). Because it reveals cooling and falling plasma, researchers track hidden energy feeding the Sun’s hot outer layer. Then, in mid-2012, nature offered a striking example.`,
    ],
  },
  {
    id: 3,
